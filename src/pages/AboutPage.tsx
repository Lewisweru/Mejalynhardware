    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-700 mb-6">
          Welcome to HomeHardware, your trusted partner in home improvement and household essentials since 2020. We take pride in offering a comprehensive selection of both hardware supplies and household items under one roof.
        </p>
